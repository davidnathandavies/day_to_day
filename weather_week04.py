...
w0im = ImageTk.PhotoImage(Image.open("weather icons/0im.png"))
w1im = ImageTk.PhotoImage(Image.open("weather icons/1im.png"))
w2im = ImageTk.PhotoImage(Image.open("weather icons/2im.png"))
w3im = ImageTk.PhotoImage(Image.open("weather icons/3im.png"))
w4im = ImageTk.PhotoImage(Image.open("weather icons/4im.png"))
w5im = ImageTk.PhotoImage(Image.open("weather icons/5im.png"))
w6im = ImageTk.PhotoImage(Image.open("weather icons/6im.png"))
w7im = ImageTk.PhotoImage(Image.open("weather icons/7im.png"))
w8im = ImageTk.PhotoImage(Image.open("weather icons/8im.png"))
w9im = ImageTk.PhotoImage(Image.open("weather icons/9im.png"))
w10im = ImageTk.PhotoImage(Image.open("weather icons/10im.png"))
w11im = ImageTk.PhotoImage(Image.open("weather icons/11im.png"))
w12im = ImageTk.PhotoImage(Image.open("weather icons/12im.png"))
w13im = ImageTk.PhotoImage(Image.open("weather icons/13im.png"))
w14im = ImageTk.PhotoImage(Image.open("weather icons/14im.png"))
w15im = ImageTk.PhotoImage(Image.open("weather icons/15im.png"))
w16im = ImageTk.PhotoImage(Image.open("weather icons/16im.png"))
w17im = ImageTk.PhotoImage(Image.open("weather icons/17im.png"))
w18im = ImageTk.PhotoImage(Image.open("weather icons/18im.png"))
w19im = ImageTk.PhotoImage(Image.open("weather icons/19im.png"))
w20im = ImageTk.PhotoImage(Image.open("weather icons/20im.png"))
w21im = ImageTk.PhotoImage(Image.open("weather icons/21im.png"))
w22im = ImageTk.PhotoImage(Image.open("weather icons/22im.png"))
w23im = ImageTk.PhotoImage(Image.open("weather icons/23im.png"))
w24im = ImageTk.PhotoImage(Image.open("weather icons/24im.png"))
w25im = ImageTk.PhotoImage(Image.open("weather icons/25im.png"))
w26im = ImageTk.PhotoImage(Image.open("weather icons/26im.png"))
w27im = ImageTk.PhotoImage(Image.open("weather icons/27im.png"))
w28im = ImageTk.PhotoImage(Image.open("weather icons/28im.png"))
w29im = ImageTk.PhotoImage(Image.open("weather icons/29im.png"))
w30im = ImageTk.PhotoImage(Image.open("weather icons/30im.png"))
